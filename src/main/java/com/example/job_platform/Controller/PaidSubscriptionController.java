...
public class PaidSubscriptionController {
	...
	@PostMapping
	public ResponseEntity<String> subscribe(@RequestBody PaidSubscriptionDTO dto){
		paidSubscriptionService.createSubscription(dto);
		return ResponseEntity.ok("Subsciption Successfully");
	}
	@GetMapping("/user/userEmail/{userEmail}")
	...
	@GetMapping("/user/recruiterId/{recruiterId}")
